    ...
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-ink px-4">
      ...
      <div className="relative w-full max-w-md">
        <div className="mb-8 text-center">
          ...
          <h1 className="mt-6 font-display text-2xl font-bold text-content">Welcome back</h1>
          <p className="mt-1 text-content-muted">Sign in to your account</p>
        </div>

        <div className="df-card p-8">
          {justVerified && (
            <div className="mb-6 flex items-center gap-2 rounded-lg border border-accent/30 bg-accent/10 px-4 py-3 text-sm text-accent">
              <svg
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              <div className="mb-1.5 flex items-center justify-between">
                <label className="block text-sm text-content-muted">Password</label>
                <Link
                  href="/forgot-password"
                  className="text-xs text-accent transition-colors hover:text-accent-2"
                >
                  Forgot password?
                </Link>
              </div>
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute right-3 top-1/2 -translate-y-1/2 text-content-faint transition-colors hover:text-content"
                  tabIndex={-1}
                >
                  {showPassword ? (
          ...
          <p className="mt-6 text-center text-sm text-content-faint">
            No account?{' '}
            <Link href="/register" className="text-accent transition-colors hover:text-accent-2">
              Create one free
            </Link>
          </p>
        </div>
