            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full bg-slate-800 border border-slate-700 rounded-lg px-4 py-3 pr-11 text-slate-100 placeholder-slate-500 focus:outline-none focus:border-violet-500 transition-colors"
                  placeholder="••••••••"
                />
                <button
                  type="button"
